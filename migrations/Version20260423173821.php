 ...
 */
final class Version20260423173821 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Créer les tables pour data-dog/audit-bundle et notre système historique';
    }

    public function up(Schema $schema): void
    {
        // S'assurer que notre table historique_logs existe correctement
        ...
        // Ajouter la contrainte de clé étrangère pour user_id si elle n'existe pas
