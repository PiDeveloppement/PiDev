...
public class CertificateService {
    ...
    public void genererCertificat(String nomParticipant, String score, String logoPath) {
        // Document en format A4 et en mode Paysage (Landscape)
        ...
        try {
            ...
            try {
                ...
                System.out.println("images/logo.png");
            }
            ...
            Paragraph pScore = new Paragraph(score + " / 10", fontScore);
            ...
            Paragraph pDate = new Paragraph("\nFait le " + dateDuJour, new Font(Font.FontFamily.HELVETICA, 12, Font.ITALIC));
